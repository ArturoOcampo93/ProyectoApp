...
if($busco){
	$noRes = 0;
	$todosDiafraces=Usuarios::buscaDisfrazConsulta($busco);
}else{
	$todosDiafraces = Usuarios::todosDisfraces();
                ...
                <div class="ImgContainer">
                    ...
                    <div class="opacity">
                        ...
                        <div class="ContentTitle">
                            <h1 class="shadowText title">concurso de Disfraz</h1>
                            ...
                            if (count($todosDiafraces) >0) {
                              for ($i=0; $i < count($todosDiafraces); $i++) {
                                ...
                                if ($i == 0) {
                                  ...
                                  <button class="boton-votar boton-disfraces votaDrisfraz" data-id="'.$id.'">Votar</button>
                                  </div>
                                  </div>
                        ...
                        <div onclick="buscar()">
                            ...
                            <div id="buscador">
                                <form action="">
                                    ...
                                    <input class="input-flex" type="text" name="nombredisfraz" id="nombredisfraz" placeholder="Nombre del participante">
                                    <input class="input-flex submit" type="button" id="btBuscar" value="Buscar">
